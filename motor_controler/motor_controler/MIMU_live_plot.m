%% IMU value liveplotting
%
% Reads IMU values from the M2 microcontroller.
% Plots the data realtime in a subplot.
% Logged into IMU_Log[time, _Value] variable.
...
% Modified even again by Andrew McGrath in October 2014
% Modified for the umpteenth time by Alex McCraw in November 2014
...
IMU_ax = zeros(1,maxPoints);                    % Pre-allocate arrays for IMU values
